...
func (action *ActionDatasetPropertyHistoryShow) Prepare() *ActionDatasetPropertyHistoryShowInvocation {
	return &ActionDatasetPropertyHistoryShowInvocation{
		Action: action,
		Path:   "/v7.0/datasets/{dataset_id}/property_history/{property_history_id}",
	}
}
...
func (inv *ActionDatasetPropertyHistoryShowInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionDatasetPropertyHistoryShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
