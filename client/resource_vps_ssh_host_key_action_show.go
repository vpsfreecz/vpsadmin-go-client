...
func (inv *ActionVpsSshHostKeyShowInvocation) validate() error {
...
func (inv *ActionVpsSshHostKeyShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
