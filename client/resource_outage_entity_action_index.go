...
func (in *ActionOutageEntityIndexInput) SetFromId(value int64) *ActionOutageEntityIndexInput {
	in.FromId = value
...
func (action *ActionOutageEntityIndex) Prepare() *ActionOutageEntityIndexInvocation {
	return &ActionOutageEntityIndexInvocation{
		Action: action,
		Path:   "/v7.0/outages/{outage_id}/entities",
	}
}
...
func (inv *ActionOutageEntityIndexInvocation) validate() error {
...
func (inv *ActionOutageEntityIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
		if inv.IsParameterSelected("FromId") {
			ret["entity[from_id]"] = convertInt64ToString(inv.Input.FromId)
		}
...
func (inv *ActionOutageEntityIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
