...
func (in *ActionMailTemplateIndexInput) SetFromId(value int64) *ActionMailTemplateIndexInput {
	in.FromId = value
...
// UnselectParameters unsets parameters from ActionMailTemplateIndexInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionMailTemplateIndexInput) UnselectParameters(params ...string) *ActionMailTemplateIndexInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (inv *ActionMailTemplateIndexInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionMailTemplateIndexInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionMailTemplateIndexInvocation) validate() error {
...
func (inv *ActionMailTemplateIndexInvocation) convertInputToQueryParams(ret map[string]string) {
	if inv.Input != nil {
		if inv.IsParameterSelected("FromId") {
			ret["mail_template[from_id]"] = convertInt64ToString(inv.Input.FromId)
		}
