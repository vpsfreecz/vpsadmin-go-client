...
// UnselectParameters unsets parameters from ActionUserTotpDeviceCreateInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionUserTotpDeviceCreateInput) UnselectParameters(params ...string) *ActionUserTotpDeviceCreateInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (inv *ActionUserTotpDeviceCreateInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionUserTotpDeviceCreateInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionUserTotpDeviceCreateInvocation) validate() error {
