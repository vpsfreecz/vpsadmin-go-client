...
func (inv *ActionNetworkInterfaceShowInvocation) validate() error {
...
func (inv *ActionNetworkInterfaceShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
