...
func (inv *ActionUserPublicKeyIndexInvocation) validate() error {
...
func (inv *ActionUserPublicKeyIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
...
func (inv *ActionUserPublicKeyIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
