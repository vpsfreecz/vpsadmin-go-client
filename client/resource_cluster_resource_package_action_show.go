...
func (inv *ActionClusterResourcePackageShowInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionClusterResourcePackageShowInvocation) validate() error {
...
func (inv *ActionClusterResourcePackageShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
