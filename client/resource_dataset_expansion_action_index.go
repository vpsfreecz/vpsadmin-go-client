...
func (inv *ActionDatasetExpansionIndexInvocation) validate() error {
...
func (inv *ActionDatasetExpansionIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
...
func (inv *ActionDatasetExpansionIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
