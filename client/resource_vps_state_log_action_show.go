...
func (inv *ActionVpsStateLogShowInvocation) validate() error {
...
func (inv *ActionVpsStateLogShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
