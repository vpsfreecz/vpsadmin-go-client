...
func (inv *ActionUserClusterResourcePackageItemShowInvocation) validate() error {
...
func (inv *ActionUserClusterResourcePackageItemShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
