...
// UnselectParameters unsets parameters from ActionMailTemplateCreateInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionMailTemplateCreateInput) UnselectParameters(params ...string) *ActionMailTemplateCreateInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (inv *ActionMailTemplateCreateInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionMailTemplateCreateInvocation) IsMetaParameterNil(param string) bool {
