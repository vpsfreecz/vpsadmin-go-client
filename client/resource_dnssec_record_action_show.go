...
func (inv *ActionDnssecRecordShowInvocation) validate() error {
...
func (inv *ActionDnssecRecordShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
