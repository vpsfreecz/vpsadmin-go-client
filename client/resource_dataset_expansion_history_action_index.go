...
func (inv *ActionDatasetExpansionHistoryIndexInvocation) validate() error {
...
func (inv *ActionDatasetExpansionHistoryIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
...
func (inv *ActionDatasetExpansionHistoryIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
