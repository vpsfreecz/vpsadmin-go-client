...
func (inv *ActionUserClusterResourcePackageDeleteInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionUserClusterResourcePackageDeleteInvocation) validate() error {
