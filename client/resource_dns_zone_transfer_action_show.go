...
func (inv *ActionDnsZoneTransferShowInvocation) validate() error {
...
func (inv *ActionDnsZoneTransferShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
