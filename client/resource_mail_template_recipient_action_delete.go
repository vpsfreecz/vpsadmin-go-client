...
func (inv *ActionMailTemplateRecipientDeleteInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionMailTemplateRecipientDeleteInvocation) validate() error {
