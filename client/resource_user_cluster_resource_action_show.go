...
func (action *ActionUserClusterResourceShow) Prepare() *ActionUserClusterResourceShowInvocation {
	return &ActionUserClusterResourceShowInvocation{
		Action: action,
		Path:   "/v7.0/users/{user_id}/cluster_resources/{cluster_resource_id}",
	}
}
...
func (inv *ActionUserClusterResourceShowInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionUserClusterResourceShowInvocation) validate() error {
...
func (inv *ActionUserClusterResourceShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
