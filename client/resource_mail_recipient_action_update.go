...
// UnselectParameters unsets parameters from ActionMailRecipientUpdateInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionMailRecipientUpdateInput) UnselectParameters(params ...string) *ActionMailRecipientUpdateInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (inv *ActionMailRecipientUpdateInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionMailRecipientUpdateInvocation) IsMetaParameterNil(param string) bool {
