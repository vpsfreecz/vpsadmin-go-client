...
// UnselectParameters unsets parameters from ActionMailTemplateUpdateInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionMailTemplateUpdateInput) UnselectParameters(params ...string) *ActionMailTemplateUpdateInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (inv *ActionMailTemplateUpdateInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionMailTemplateUpdateInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionMailTemplateUpdateInvocation) validate() error {
