...
func (inv *ActionOomReportTaskShowInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionOomReportTaskShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
