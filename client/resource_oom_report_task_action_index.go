...
func (inv *ActionOomReportTaskIndexInvocation) validate() error {
...
func (inv *ActionOomReportTaskIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
...
func (inv *ActionOomReportTaskIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
