...
func (inv *ActionUserRequestRegistrationPreviewInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionUserRequestRegistrationPreviewInvocation) validate() error {
...
func (inv *ActionUserRequestRegistrationPreviewInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
