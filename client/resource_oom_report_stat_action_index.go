...
// UnselectParameters unsets parameters from ActionOomReportStatIndexInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionOomReportStatIndexInput) UnselectParameters(params ...string) *ActionOomReportStatIndexInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (inv *ActionOomReportStatIndexInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionOomReportStatIndexInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionOomReportStatIndexInvocation) validate() error {
...
func (inv *ActionOomReportStatIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
...
func (inv *ActionOomReportStatIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
