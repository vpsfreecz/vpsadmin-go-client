...
func (in *ActionIntegrityCheckIndexInput) SetUserNil(set bool) *ActionIntegrityCheckIndexInput {
...
// UnselectParameters unsets parameters from ActionIntegrityCheckIndexInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionIntegrityCheckIndexInput) UnselectParameters(params ...string) *ActionIntegrityCheckIndexInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (inv *ActionIntegrityCheckIndexInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionIntegrityCheckIndexInvocation) IsMetaParameterNil(param string) bool {
