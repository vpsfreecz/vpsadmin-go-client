...
func (inv *ActionMailTemplateRecipientShowInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionMailTemplateRecipientShowInvocation) validate() error {
