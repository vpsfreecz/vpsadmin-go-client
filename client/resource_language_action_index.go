...
func (in *ActionLanguageIndexInput) SetFromId(value int64) *ActionLanguageIndexInput {
	in.FromId = value
...
func (inv *ActionLanguageIndexInvocation) validate() error {
...
func (inv *ActionLanguageIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
		if inv.IsParameterSelected("FromId") {
			ret["language[from_id]"] = convertInt64ToString(inv.Input.FromId)
		}
...
func (inv *ActionLanguageIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
