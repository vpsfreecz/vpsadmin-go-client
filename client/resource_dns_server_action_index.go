...
func (inv *ActionDnsServerIndexInvocation) validate() error {
...
func (inv *ActionDnsServerIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
...
func (inv *ActionDnsServerIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
