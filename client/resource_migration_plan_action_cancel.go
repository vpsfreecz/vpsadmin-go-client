...
func (action *ActionMigrationPlanCancel) Prepare() *ActionMigrationPlanCancelInvocation {
	return &ActionMigrationPlanCancelInvocation{
		Action: action,
		Path:   "/v7.0/migration_plans/{migration_plan_id}/cancel",
	}
}
...
func (inv *ActionMigrationPlanCancelInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionMigrationPlanCancelInvocation) validate() error {
