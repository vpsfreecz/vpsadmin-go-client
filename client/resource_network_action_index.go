...
func (inv *ActionNetworkIndexInvocation) validate() error {
...
func (inv *ActionNetworkIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
...
func (inv *ActionNetworkIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
