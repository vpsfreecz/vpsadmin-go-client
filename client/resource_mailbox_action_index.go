...
func (inv *ActionMailboxIndexInvocation) validate() error {
...
func (inv *ActionMailboxIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
...
func (inv *ActionMailboxIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
