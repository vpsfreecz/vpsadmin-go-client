...
func (inv *ActionUserKnownDeviceIndexInvocation) validate() error {
...
func (inv *ActionUserKnownDeviceIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
...
func (inv *ActionUserKnownDeviceIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
