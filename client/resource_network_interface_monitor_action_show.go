...
func (inv *ActionNetworkInterfaceMonitorShowInvocation) validate() error {
...
func (inv *ActionNetworkInterfaceMonitorShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
