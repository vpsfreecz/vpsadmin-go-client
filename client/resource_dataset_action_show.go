...
func (inv *ActionDatasetShowInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionDatasetShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
