...
// UnselectParameters unsets parameters from ActionVpsMountUpdateInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionVpsMountUpdateInput) UnselectParameters(params ...string) *ActionVpsMountUpdateInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (inv *ActionVpsMountUpdateInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionVpsMountUpdateInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionVpsMountUpdateInvocation) validate() error {
