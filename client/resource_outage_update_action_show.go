...
func (action *ActionOutageUpdateShow) Prepare() *ActionOutageUpdateShowInvocation {
	return &ActionOutageUpdateShowInvocation{
		Action: action,
		Path:   "/v7.0/outage_updates/{outage_update_id}",
	}
}
...
func (inv *ActionOutageUpdateShowInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionOutageUpdateShowInvocation) validate() error {
...
func (inv *ActionOutageUpdateShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
