...
func (inv *ActionTransactionChainShowInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionTransactionChainShowInvocation) validate() error {
...
func (inv *ActionTransactionChainShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
