...
func (in *ActionMailboxHandlerIndexInput) SetFromId(value int64) *ActionMailboxHandlerIndexInput {
	in.FromId = value
...
func (action *ActionMailboxHandlerIndex) Prepare() *ActionMailboxHandlerIndexInvocation {
	return &ActionMailboxHandlerIndexInvocation{
		Action: action,
		Path:   "/v7.0/mailboxes/{mailbox_id}/handler",
	}
}
...
func (inv *ActionMailboxHandlerIndexInvocation) validate() error {
...
func (inv *ActionMailboxHandlerIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
...
func (inv *ActionMailboxHandlerIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
