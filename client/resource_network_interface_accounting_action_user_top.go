...
func (inv *ActionNetworkInterfaceAccountingUserTopInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
		if inv.IsParameterSelected("Environment") {
...
func (inv *ActionNetworkInterfaceAccountingUserTopInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
