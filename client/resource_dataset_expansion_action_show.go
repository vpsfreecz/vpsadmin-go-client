...
func (inv *ActionDatasetExpansionShowInvocation) validate() error {
...
func (inv *ActionDatasetExpansionShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
