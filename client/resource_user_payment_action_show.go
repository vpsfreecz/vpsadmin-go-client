...
func (inv *ActionUserPaymentShowInvocation) validate() error {
...
func (inv *ActionUserPaymentShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
