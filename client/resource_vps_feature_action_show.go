...
func (inv *ActionVpsFeatureShowInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionVpsFeatureShowInvocation) validate() error {
...
func (inv *ActionVpsFeatureShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
