...
// UnselectParameters unsets parameters from ActionVpsStateLogIndexInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionVpsStateLogIndexInput) UnselectParameters(params ...string) *ActionVpsStateLogIndexInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (inv *ActionVpsStateLogIndexInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionVpsStateLogIndexInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionVpsStateLogIndexInvocation) validate() error {
