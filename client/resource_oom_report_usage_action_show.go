...
func (inv *ActionOomReportUsageShowInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionOomReportUsageShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
