...
func (in *ActionClusterResourcePackageItemIndexInput) SetFromId(value int64) *ActionClusterResourcePackageItemIndexInput {
	in.FromId = value
...
// UnselectParameters unsets parameters from ActionClusterResourcePackageItemIndexInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionClusterResourcePackageItemIndexInput) UnselectParameters(params ...string) *ActionClusterResourcePackageItemIndexInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (inv *ActionClusterResourcePackageItemIndexInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionClusterResourcePackageItemIndexInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionClusterResourcePackageItemIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
...
func (inv *ActionClusterResourcePackageItemIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
