...
func (inv *ActionClusterResourceShowInvocation) validate() error {
...
func (inv *ActionClusterResourceShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
