...
func (in *ActionIpTrafficUserTopInput) SetEnvironmentNil(set bool) *ActionIpTrafficUserTopInput {
...
func (in *ActionIpTrafficUserTopInput) SetLocationNil(set bool) *ActionIpTrafficUserTopInput {
	if in._nilParameters == nil {
		if !set {
			return in
		}
...
func (in *ActionIpTrafficUserTopInput) SetNetworkNil(set bool) *ActionIpTrafficUserTopInput {
	if in._nilParameters == nil {
		if !set {
			return in
		}
...
func (in *ActionIpTrafficUserTopInput) SetNodeNil(set bool) *ActionIpTrafficUserTopInput {
	if in._nilParameters == nil {
		if !set {
			return in
		}
...
// UnselectParameters unsets parameters from ActionIpTrafficUserTopInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionIpTrafficUserTopInput) UnselectParameters(params ...string) *ActionIpTrafficUserTopInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (inv *ActionIpTrafficUserTopInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionIpTrafficUserTopInvocation) IsMetaParameterNil(param string) bool {
