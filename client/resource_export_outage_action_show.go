...
func (inv *ActionExportOutageShowInvocation) validate() error {
...
func (inv *ActionExportOutageShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
