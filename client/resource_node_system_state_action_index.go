...
func (inv *ActionNodeSystemStateIndexInvocation) convertInputToQueryParams(ret map[string]string) {
	if inv.Input != nil {
...
func (inv *ActionNodeSystemStateIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) {
	if inv.MetaInput != nil {
