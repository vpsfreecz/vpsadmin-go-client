...
func (action *ActionSnapshotDownloadShow) Prepare() *ActionSnapshotDownloadShowInvocation {
	return &ActionSnapshotDownloadShowInvocation{
		Action: action,
		Path:   "/v7.0/snapshot_downloads/{snapshot_download_id}",
	}
}
...
func (inv *ActionSnapshotDownloadShowInvocation) validate() error {
...
func (inv *ActionSnapshotDownloadShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
