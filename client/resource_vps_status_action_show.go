...
func (inv *ActionVpsStatusShowInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionVpsStatusShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
