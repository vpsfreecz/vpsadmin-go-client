...
func (action *ActionDatasetPlanShow) Prepare() *ActionDatasetPlanShowInvocation {
	return &ActionDatasetPlanShowInvocation{
		Action: action,
		Path:   "/v7.0/dataset_plans/{dataset_plan_id}",
	}
}
...
func (inv *ActionDatasetPlanShowInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionDatasetPlanShowInvocation) validate() error {
