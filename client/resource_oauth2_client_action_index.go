...
func (inv *ActionOauth2ClientIndexInvocation) validate() error {
...
func (inv *ActionOauth2ClientIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
...
func (inv *ActionOauth2ClientIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
