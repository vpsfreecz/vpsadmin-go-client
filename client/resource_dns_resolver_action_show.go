...
func (inv *ActionDnsResolverShowInvocation) validate() error {
...
func (inv *ActionDnsResolverShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
