...
func (inv *ActionVpsUserDataIndexInvocation) validate() error {
...
func (inv *ActionVpsUserDataIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
...
func (inv *ActionVpsUserDataIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
