...
func (inv *ActionUserStateLogShowInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionUserStateLogShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
