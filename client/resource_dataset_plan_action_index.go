...
func (inv *ActionDatasetPlanIndexInvocation) validate() error {
...
func (inv *ActionDatasetPlanIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
...
func (inv *ActionDatasetPlanIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
