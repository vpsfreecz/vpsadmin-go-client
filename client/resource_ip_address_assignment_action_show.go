...
func (inv *ActionIpAddressAssignmentShowInvocation) validate() error {
...
func (inv *ActionIpAddressAssignmentShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
