...
func (inv *ActionClusterResourcePackageItemDeleteInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionClusterResourcePackageItemDeleteInvocation) validate() error {
