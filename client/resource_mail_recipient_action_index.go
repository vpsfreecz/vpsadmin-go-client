...
func (in *ActionMailRecipientIndexInput) SetFromId(value int64) *ActionMailRecipientIndexInput {
	in.FromId = value
...
// UnselectParameters unsets parameters from ActionMailRecipientIndexInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionMailRecipientIndexInput) UnselectParameters(params ...string) *ActionMailRecipientIndexInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (inv *ActionMailRecipientIndexInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionMailRecipientIndexInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionMailRecipientIndexInvocation) validate() error {
...
func (inv *ActionMailRecipientIndexInvocation) convertInputToQueryParams(ret map[string]string) {
	if inv.Input != nil {
		if inv.IsParameterSelected("FromId") {
			ret["mail_recipient[from_id]"] = convertInt64ToString(inv.Input.FromId)
		}
