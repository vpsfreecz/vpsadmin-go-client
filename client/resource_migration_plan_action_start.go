...
func (action *ActionMigrationPlanStart) Prepare() *ActionMigrationPlanStartInvocation {
	return &ActionMigrationPlanStartInvocation{
		Action: action,
		Path:   "/v7.0/migration_plans/{migration_plan_id}/start",
	}
}
...
func (inv *ActionMigrationPlanStartInvocation) NewMetaInput() *ActionMigrationPlanStartMetaGlobalInput {
	inv.MetaInput = &ActionMigrationPlanStartMetaGlobalInput{}
...
func (inv *ActionMigrationPlanStartInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionMigrationPlanStartInvocation) validate() error {
