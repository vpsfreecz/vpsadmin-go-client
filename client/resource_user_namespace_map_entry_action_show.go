...
func (inv *ActionUserNamespaceMapEntryShowInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionUserNamespaceMapEntryShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
