...
func (action *ActionUserNamespaceShow) Prepare() *ActionUserNamespaceShowInvocation {
	return &ActionUserNamespaceShowInvocation{
		Action: action,
		Path:   "/v7.0/user_namespaces/{user_namespace_id}",
	}
}
...
func (inv *ActionUserNamespaceShowInvocation) NewMetaInput() *ActionUserNamespaceShowMetaGlobalInput {
	inv.MetaInput = &ActionUserNamespaceShowMetaGlobalInput{}
...
func (inv *ActionUserNamespaceShowInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionUserNamespaceShowInvocation) validate() error {
...
func (inv *ActionUserNamespaceShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
