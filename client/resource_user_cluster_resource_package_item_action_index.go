...
func (in *ActionUserClusterResourcePackageItemIndexInput) SetFromId(value int64) *ActionUserClusterResourcePackageItemIndexInput {
	in.FromId = value
...
// UnselectParameters unsets parameters from ActionUserClusterResourcePackageItemIndexInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionUserClusterResourcePackageItemIndexInput) UnselectParameters(params ...string) *ActionUserClusterResourcePackageItemIndexInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (action *ActionUserClusterResourcePackageItemIndex) Prepare() *ActionUserClusterResourcePackageItemIndexInvocation {
	return &ActionUserClusterResourcePackageItemIndexInvocation{
		Action: action,
		Path:   "/v7.0/user_cluster_resource_packages/{user_cluster_resource_package_id}/items",
	}
}
...
func (inv *ActionUserClusterResourcePackageItemIndexInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionUserClusterResourcePackageItemIndexInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionUserClusterResourcePackageItemIndexInvocation) validate() error {
...
func (inv *ActionUserClusterResourcePackageItemIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
		if inv.IsParameterSelected("FromId") {
			ret["item[from_id]"] = convertInt64ToString(inv.Input.FromId)
		}
...
func (inv *ActionUserClusterResourcePackageItemIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
