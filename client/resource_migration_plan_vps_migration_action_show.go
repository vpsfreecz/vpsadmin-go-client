...
func (inv *ActionMigrationPlanVpsMigrationShowInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionMigrationPlanVpsMigrationShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
