...
func (inv *ActionOauth2ClientShowInvocation) validate() error {
...
func (inv *ActionOauth2ClientShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
