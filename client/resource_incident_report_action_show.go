...
func (inv *ActionIncidentReportShowInvocation) validate() error {
...
func (inv *ActionIncidentReportShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
