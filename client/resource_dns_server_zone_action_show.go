...
func (inv *ActionDnsServerZoneShowInvocation) validate() error {
...
func (inv *ActionDnsServerZoneShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
