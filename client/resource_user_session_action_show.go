...
func (inv *ActionUserSessionShowInvocation) validate() error {
...
func (inv *ActionUserSessionShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
