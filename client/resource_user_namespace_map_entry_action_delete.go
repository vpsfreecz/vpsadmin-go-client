...
func (inv *ActionUserNamespaceMapEntryDeleteInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionUserNamespaceMapEntryDeleteInvocation) validate() error {
