...
// UnselectParameters unsets parameters from ActionUserClusterResourcePackageUpdateInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionUserClusterResourcePackageUpdateInput) UnselectParameters(params ...string) *ActionUserClusterResourcePackageUpdateInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (inv *ActionUserClusterResourcePackageUpdateInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionUserClusterResourcePackageUpdateInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionUserClusterResourcePackageUpdateInvocation) validate() error {
