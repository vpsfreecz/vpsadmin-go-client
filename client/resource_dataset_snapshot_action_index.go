...
func (inv *ActionDatasetSnapshotIndexInvocation) validate() error {
...
func (inv *ActionDatasetSnapshotIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
...
func (inv *ActionDatasetSnapshotIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
