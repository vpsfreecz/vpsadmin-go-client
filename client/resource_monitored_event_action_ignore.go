...
// UnselectParameters unsets parameters from ActionMonitoredEventIgnoreInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionMonitoredEventIgnoreInput) UnselectParameters(params ...string) *ActionMonitoredEventIgnoreInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (action *ActionMonitoredEventIgnore) Prepare() *ActionMonitoredEventIgnoreInvocation {
	return &ActionMonitoredEventIgnoreInvocation{
		Action: action,
		Path:   "/v7.0/monitored_events/{monitored_event_id}/ignore",
	}
}
...
func (inv *ActionMonitoredEventIgnoreInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionMonitoredEventIgnoreInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionMonitoredEventIgnoreInvocation) validate() error {
