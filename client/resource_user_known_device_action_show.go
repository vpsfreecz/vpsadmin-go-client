...
func (inv *ActionUserKnownDeviceShowInvocation) validate() error {
...
func (inv *ActionUserKnownDeviceShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
