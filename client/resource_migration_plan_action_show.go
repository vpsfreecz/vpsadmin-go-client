...
func (action *ActionMigrationPlanShow) Prepare() *ActionMigrationPlanShowInvocation {
	return &ActionMigrationPlanShowInvocation{
		Action: action,
		Path:   "/v7.0/migration_plans/{migration_plan_id}",
	}
}
...
func (inv *ActionMigrationPlanShowInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionMigrationPlanShowInvocation) validate() error {
...
func (inv *ActionMigrationPlanShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
