...
func (inv *ActionUserTouchInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionUserTouchInvocation) validate() error {
...
func (inv *ActionUserTouchInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
