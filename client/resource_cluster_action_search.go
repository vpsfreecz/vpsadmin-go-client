...
// UnselectParameters unsets parameters from ActionClusterSearchInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionClusterSearchInput) UnselectParameters(params ...string) *ActionClusterSearchInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (inv *ActionClusterSearchInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionClusterSearchInvocation) IsMetaParameterNil(param string) bool {
