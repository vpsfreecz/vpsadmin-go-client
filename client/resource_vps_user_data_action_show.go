...
func (inv *ActionVpsUserDataShowInvocation) validate() error {
...
func (inv *ActionVpsUserDataShowInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
