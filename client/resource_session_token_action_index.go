...
func (in *ActionSessionTokenIndexInput) SetUserNil(set bool) *ActionSessionTokenIndexInput {
...
// UnselectParameters unsets parameters from ActionSessionTokenIndexInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionSessionTokenIndexInput) UnselectParameters(params ...string) *ActionSessionTokenIndexInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (inv *ActionSessionTokenIndexInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionSessionTokenIndexInvocation) IsMetaParameterNil(param string) bool {
