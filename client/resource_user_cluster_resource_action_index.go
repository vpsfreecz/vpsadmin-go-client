...
func (in *ActionUserClusterResourceIndexInput) SetFromId(value int64) *ActionUserClusterResourceIndexInput {
	in.FromId = value
...
// UnselectParameters unsets parameters from ActionUserClusterResourceIndexInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionUserClusterResourceIndexInput) UnselectParameters(params ...string) *ActionUserClusterResourceIndexInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (inv *ActionUserClusterResourceIndexInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionUserClusterResourceIndexInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionUserClusterResourceIndexInvocation) validate() error {
...
func (inv *ActionUserClusterResourceIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
		if inv.IsParameterSelected("Environment") {
...
func (inv *ActionUserClusterResourceIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
