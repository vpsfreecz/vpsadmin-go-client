...
func (inv *ActionNodeKernelLivepatchPatchIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
		if inv.IsParameterSelected("From") {
...
func (inv *ActionNodeKernelLivepatchPatchIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
