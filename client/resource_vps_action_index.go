...
func (inv *ActionVpsIndexInvocation) validate() error {
...
func (inv *ActionVpsIndexInvocation) convertInputToQueryParams(ret map[string]string) error {
	if inv.Input != nil {
		if inv.IsParameterSelected("Environment") {
...
func (inv *ActionVpsIndexInvocation) convertMetaInputToQueryParams(ret map[string]string) error {
	if inv.MetaInput != nil {
