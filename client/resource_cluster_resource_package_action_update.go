...
// UnselectParameters unsets parameters from ActionClusterResourcePackageUpdateInput
// that will be sent to the API.
// UnsSelectParameters can be called multiple times.
func (in *ActionClusterResourcePackageUpdateInput) UnselectParameters(params ...string) *ActionClusterResourcePackageUpdateInput {
	if in._selectedParameters == nil {
		return in
	}
...
func (action *ActionClusterResourcePackageUpdate) Prepare() *ActionClusterResourcePackageUpdateInvocation {
	return &ActionClusterResourcePackageUpdateInvocation{
		Action: action,
		Path:   "/v7.0/cluster_resource_packages/{cluster_resource_package_id}",
	}
}
...
func (inv *ActionClusterResourcePackageUpdateInvocation) IsParameterNil(param string) bool {
...
func (inv *ActionClusterResourcePackageUpdateInvocation) IsMetaParameterNil(param string) bool {
...
func (inv *ActionClusterResourcePackageUpdateInvocation) validate() error {
